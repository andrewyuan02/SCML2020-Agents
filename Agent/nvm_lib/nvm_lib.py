...
class NVMLib:
    def __init__(self,
        ...
        if self.check_if_data_exists():
            ...
            q_uncertainty_model = NVMLib.get_json_dict(f'data/dict_qtty_num_intermediate_products_{self.num_intermediate_products}.json')
            ...
            prices = NVMLib.get_json_dict(f'data/dict_price_num_intermediate_products_{self.num_intermediate_products}.json')
    ...
    def check_if_data_exists(self) -> bool:
        ...
        :return:
        """
        if not os.path.isfile(f'data/dict_qtty_num_intermediate_products_{self.num_intermediate_products}.json'):
        ...
        if not os.path.isfile(f'data/dict_price_num_intermediate_products_{self.num_intermediate_products}.json'):
    ...
    def get_complete_plan(self, current_time: int, verbose: bool = False) -> Optional[list]:
        """
